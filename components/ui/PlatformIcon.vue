...
const facebookSvg = `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
...
<template>
  <div v-html="icons[props.platform]" class="w-6 h-6"></div>
</template>
