  ...
  >
    ...
    >
      ...
      >
        <!-- Facebook icon SVG -->
        <div
          v-if="props.post.platform === 'facebook'"
          v-html="facebookIcon"
          :class="[compact ? 'w-5 h-5' : 'w-6 h-6']"
        ></div>
        <!-- Instagram icon SVG -->
        <div
          v-else-if="props.post.platform === 'instagram'"
          v-html="instagramIcon"
          :class="[compact ? 'w-5 h-5' : 'w-6 h-6']"
        ></div>
        <!-- Twitter/X icon SVG -->
        <div
          v-else-if="props.post.platform === 'twitter'"
          v-html="twitterIcon"
          :class="[compact ? 'w-5 h-5' : 'w-6 h-6']"
        ></div>
        <!-- LinkedIn icon SVG -->
        <div
          v-else-if="props.post.platform === 'linkedin'"
          v-html="linkedinIcon"
          :class="[compact ? 'w-5 h-5' : 'w-6 h-6']"
        ></div>
        <!-- Pinterest icon SVG -->
        <div
          v-else-if="props.post.platform === 'pinterest'"
          v-html="pinterestIcon"
          :class="[compact ? 'w-5 h-5' : 'w-6 h-6']"
        ></div>
        <!-- TikTok icon SVG -->
        <div
          v-else-if="props.post.platform === 'tiktok'"
          v-html="tiktokIcon"
          :class="[compact ? 'w-5 h-5' : 'w-6 h-6']"
        ></div>
      </div>
