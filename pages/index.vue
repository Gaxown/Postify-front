  ...
  <div>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
          ...
          <div class="flex rounded-lg border border-gray-300">
            <button class="px-3 py-2 text-sm font-medium text-gray-700 bg-gray-50 border-r border-gray-300">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/>
              </svg>
            </button>
            <button class="px-3 py-2 text-sm font-medium text-gray-500 bg-white">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button @click="openNewPostModal" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="border-b border-gray-200 mb-6">
      <nav class="-mb-px flex space-x-8">
        ...
        >
          {{ tab.name }}
          <span v-if="tab.count > 0" class="ml-2 bg-gray-100 text-gray-600 py-0.5 px-2 rounded-full text-xs">{{ tab.count }}</span>
        </button>
      </nav>
    </div>
    ...
    <div class="space-y-6">
      ...
      <div v-if="todaysPosts.length > 0">
        <h2 class="text-lg font-medium text-gray-900 mb-4">Today, {{ formatDate(new Date()) }}</h2>
        
        <div class="space-y-4">
          <div v-for="post in todaysPosts" :key="post.id" class="bg-white border border-gray-200 rounded-lg p-6">
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <!-- Post Preview -->
                <div v-if="post.hasMedia" class="mt-4 bg-purple-600 rounded-lg p-6 text-white">
      ...
      <div v-else class="text-center py-12">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">No posts scheduled</h3>
...
const todaysPosts = ref([
  {
    id: 1,
    content: 'Just shipped a new feature for our social media scheduler! 🚀 Excited to see how our users will leverage this to streamline their content workflow.',
  ...
  {
    id: 2,
    content: 'Behind the scenes at Postify: Building tools that help creators focus on what they do best - creating amazing content! 💡',
