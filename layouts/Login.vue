      ...
      >
        ...
        <div class="h-full flex flex-col justify-center px-12">
          ...
          <p class="text-xl text-purple-100 mb-8 leading-relaxed max-w-md">
            Create AI-tailored content, designed specifically for your audience
            and social network.
          </p>
            ...
            >
              ...
              <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                <p class="text-sm text-gray-800 leading-relaxed">
                  Fancy a freshly brewed cup from your local coffee shop? Come
                  and try our new espresso!
                </p>
              </div>
            </div>
            ...
            >
              ...
              <p class="text-xs text-gray-600">
                ...
                <span class="text-purple-600"
                  >down to try our brand new espresso option</span
                >
              </p>
            </div>
          </div>
