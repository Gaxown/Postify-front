<template>
  <div class="min-h-screen flex">
    ...
    <div class="flex-1 bg-white flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div>
          ...
          <!-- Error message -->
          <div v-if="loginError" class="mt-6 bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex">
    ...
    <div class="hidden lg:block relative w-0 flex-1">
      <div class="absolute inset-0 bg-gradient-to-br from-purple-600 via-purple-700 to-blue-800">
        ...
        <div class="h-full flex flex-col justify-center px-12">
          ...
          <div class="relative max-w-md">
            ...
            <!-- Create Post Card -->
            <div class="absolute right-0 top-16 w-48 bg-white bg-opacity-95 backdrop-blur-sm rounded-lg p-4 shadow-xl">
              ...
              <div class="flex space-x-2 mb-3">
                <div v-for="i in 5" :key="i" class="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                  <span v-if="i === 1" class="text-pink-500 text-sm">+</span>
                  <span v-else class="text-gray-400 text-xs">{{ i === 2 ? 'G' : i === 3 ? 'F' : i === 4 ? 'L' : 'T' }}</span>
                </div>
              </div>
